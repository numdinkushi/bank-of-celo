...
export const CELO_JACKPOTV2_ABI = [
  ...
  export const BANK_OF_DEGEN_ADDRESS = "0xaFbFAaac9c495C74de33c039C0B56172b393d2Ad" as `0x${string}`;
...
export const DEGEN_DAILY_CHECKIN_ADDRESS = "0xb2e22CdfaB5274186498CedD66b5801e80e98299" as `0x${string}`;
export const DEGEN_DAILY_CHECKIN_ABI = [
  ...
  export const DEGEN_JACKPOT_ADDRESS = "0xD8407eE0b2B1008FAb9e2bD8Ab9005F2dA8BEE67" as `0x${string}`;
