...
export default function LoansModal({
    ...
    const handleApplyLoan = async () => {
        ...
        if (!loanDetails || parseFloat(collateralAmount) < parseFloat(loanDetails.requiredCollateral)) {
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-100">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-gray-900">Crypto Loans</h2>
                        ...
                        <div className="overflow-y-auto flex-1 p-6">
                            ...
                            {!isCorrectChain && (
                                ...
                                >
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium text-amber-800">Network Switch Required</p>
                                            <p className="text-xs text-amber-700">Please switch to Celo Network to proceed</p>
                                        </div>
                                    </div>
                                </motion.div>
                            )}
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    {loanTerms.map((term) => (
                                        <motion.button
                                            ...
                                            className={`p-4 rounded-xl border-2 transition-all text-left ${selectedTerm === term.id
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-2">
                                                ...
                                                <span className={`text-sm font-medium ${selectedTerm === term.id ? `text-${term.color}-600` : "text-gray-600"
                                                    }`}>
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-xs text-gray-500 mt-1">Available balance: {vaultBalance} CELO</p>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                {loanDetails && (
                                    <p className="text-xs text-gray-500 mt-1">
                                        Required: {loanDetails.requiredCollateral} CELO (150% collateralization)
                                    </p>
                                )}
                            </div>
                                ...
                                >
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="font-medium text-gray-900">{loanAmount} CELO</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <span className="text-sm text-gray-600">Interest ({selectedTermData?.interestRate})</span>
                                            <span className="font-medium text-red-600">+{loanDetails.interest} CELO</span>
                                        </div>
                                        <div className="flex justify-between items-center pt-2 border-t border-blue-200">
                                            <span className="text-sm font-medium text-gray-900">Total Repayment</span>
                                            <span className="font-bold text-blue-600">{loanDetails.totalRepayment} CELO</span>
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <span className="text-sm text-gray-600">Daily Interest Rate</span>
                                            <span className="text-sm text-gray-900">{loanDetails.dailyRate}%</span>
                                        </div>
                                    </div>
                                </motion.div>
                            )}
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-red-800 mb-1">Liquidation Risk</p>
                                        <p className="text-xs text-red-700">
                                            Your collateral may be liquidated if its value falls below 130% of the loan amount.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-xl p-4 mb-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-800 mb-1">How it works</p>
                        ...
                        <div className="p-6 border-t border-gray-100 bg-gray-50">
                            <button
                                ...
                                disabled={!loanAmount || !collateralAmount || !isCorrectChain || isLoading}
                                className={`w-full py-4 rounded-xl font-semibold text-white transition-all ${!loanAmount || !collateralAmount || !isCorrectChain || isLoading
